...
venue: "Carpentries @ MIT: Intro to Python/Git - Whitehead Institute"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "December 8-9, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "Dec 8: 9AM-4PM ET, Dec 9: 1-4:30 PM ET"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2022-12-08      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2022-12-09        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Phoebe Ayers", "Ye Li", "Daniel Sheehan", "Ece Turnator", "Barbara Williams"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jack Goodspeed Payette", "Mark Szarko", "Christine Malinowski"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2022-12-08-mit # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<p id="who-can-attend">
    ...
    (We are scheduling another workshop open to all MIT affliates and the public on January 25 - 27, 2023. Please stay tuned. ) 
</p>
